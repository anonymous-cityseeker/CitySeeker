...
from utils.items import ViewPointAttrToUpdate, ViewPoint, VisitStatus, ViewPointPosition, \
    ViewPointPositionWithObservation
...
class Neo4jClient:
        ...
        for record in result:
            ...
            for relationship in relationship_list:
                relationships.append({
                    ...
                    "distance": relationship.get("distance", None),
                    "azimuth": relationship.get("azimuth", None)
                })
    ...
    def query_topology_distance(self, filename: str, topology_distance: int = 1):
        ...
        if not result:
            ...
            return {"relationships": [], "nodes": []}  # 先返回 relationships，再返回 nodes
    ...
    def get_proper_perspective_after_backtrack(self,
        ...
        forward_azimuth = Compass.get_step_forward_azimuth(
            ...
            curr_position=ViewPointPosition(filename=gt_next_viewpoint["filename"],
                                            longitude=gt_next_viewpoint["longitude"],
                                            latitude=gt_next_viewpoint["latitude"]),
        )
